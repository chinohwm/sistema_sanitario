...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-09-2025 a las 16:36:36
...
(37, 'ad', 'da', 'ad', 'Si', 'asasd', '2025-10-11');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `localidades_la_matanza`
--

CREATE TABLE `localidades_la_matanza` (
  `id` int(11) NOT NULL,
  `nombre` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `localidades_la_matanza`
--

INSERT INTO `localidades_la_matanza` (`id`, `nombre`) VALUES
(1, '20 de Junio'),
(2, 'Aldo Bonzi'),
(3, 'Ciudad Celina'),
(4, 'Ciudad Evita'),
...
CREATE TABLE `pacientes` (
  ...
  `localidad` varchar(50) NOT NULL,
  `localidad_op` varchar(222) NOT NULL,
...
INSERT INTO `pacientes` (`id_paciente`, `nombre`, `apellido`, `dni`, `celular`, `genero`, `fecha_nacimiento`, `correo_electronico`, `localidad`, `localidad_op`, `domicilio`, `obra_social`) VALUES
(35, 'Norma', 'Pereira', '12345066', 1157225992, 'Femenino', '1954-07-01', '@', 'San justo', '', 'Montanesas 3963', 'Si'),
(36, 'Silvia', 'Narracci', '10395407', 1169378964, 'Femenino', '1952-09-24', '@', 'Ramos mejia', '', 'Bolivar 2470', 'No'),
(37, 'Jacinto ', 'Catriel', '8215436', 0, 'Masculino', '1951-08-24', '@jose', 'Ramos Mejia', '', 'Nicaragua 222', 'No'),
(38, 'Juan', 'Sosa', '7785312', 1151757346, 'Masculino', '1947-03-22', '@', 'Isidro casanova', '', 'Los andes 3691', 'Si'),
(39, 'Aldo', 'Tevez', '13282772', 11622626, 'Masculino', '1956-08-30', '@', 'Isidro Casanova', '', 'Albarellos 5256', 'Si'),
(40, 'Aminda ', 'Jallasi ', '94209834', 1123103005, 'Femenino', '1975-02-08', '@', 'R.castillo', '', 'Eduardo Bunje 48', 'No'),
(41, 'Silvia ', 'Huallpacuiza', '95814503', 1123010892, 'Femenino', '1992-05-19', '@', 'V.fiorito', '', 'Canada 1476', 'No'),
(42, 'Lidia ', 'Gonzalez ', '16783517', 1167081470, 'Femenino', '1962-03-11', '@', 'San justo ', '', 'Guatemala 4656', 'Si'),
(43, 'Veronica ', 'Turca ', '45275536', 1162606370, 'Femenino', '1955-07-03', '@', 'L. de zamora', '', 'J.M.De rosas 11 de julio ', 'No'),
(44, 'Juana', 'Colque', '44283988', 0, 'Femenino', '1986-03-03', '@', 'R. Castillo', '', 'Mza 10 casa 20 sn ', 'No'),
(45, 'Francisca ', 'Pongo', '94470256', 1134777256, 'Femenino', '1974-12-03', '@', 'B.Union', '', 'G.merou sn ', 'No'),
(46, 'Paulina ', 'Mamani ', '95763901', 1136665534, 'Femenino', '1984-03-02', '@', 'B.Union ', '', 'Anamariag. 3678', 'No'),
(47, 'Dionisia ', 'Martinez', '94283426', 1168693571, 'Femenino', '1962-12-08', '@', 'C. evita ', '', 'El quebracho 900', 'No'),
(48, 'lautarro', 'suarrez', '23', 2147483647, 'Femenino', '2025-09-05', 'lauticra@gmail.com', 'gonzales catan', '', 'nose', 'Si');
...
(36, 'jose c paz', 'bs a', 'as', 'Si', 'as', '2025-09-04'),
(36, 'ad', 'ad', 'ad', 'Si', 'adad', '123123-12-12'),
(44, 'asdasd', 'asdasd', 'asdasd', 'Si', 'dasdasd', '2025-10-01');
...
--
-- Volcado de datos para la tabla `sifilis`
--

INSERT INTO `sifilis` (`id_paciente`, `sifilis`, `observacion`, `derivacion`) VALUES
(37, 'Negativo', 'hola', 'Si');
...
CREATE TABLE `vacunas` (
  ...
  `antigripal` int(11) NOT NULL,
  `pv20` int(11) NOT NULL,
  `fiebre_amarrilla` int(11) NOT NULL,
  `doble_viral` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `localidades_la_matanza`
--
ALTER TABLE `localidades_la_matanza`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `localidades_la_matanza`
--
ALTER TABLE `localidades_la_matanza`
...
--
ALTER TABLE `pacientes`
  MODIFY `id_paciente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
